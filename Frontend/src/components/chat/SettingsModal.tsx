                                ...
                                <div className={`rounded-2xl p-8 text-white shadow-xl relative overflow-hidden group border border-white/10 ${isPro ? 'bg-gradient-to-br from-emerald-900/80 to-emerald-600/80 shadow-emerald-500/10' : 'bg-surface/30'}`}>
                                    ...
                                    <div className="relative z-10 space-y-6">
                                        ...
                                        <div className="pt-4 border-t border-white/10">
                                            <p className="text-xs text-white/50 mb-3">⚠️ Testing Only - Toggle Plan</p>
                                            <button
                                                onClick={handleTogglePlan}
                                                disabled={isToggling}
                                                className="flex items-center justify-center gap-2 w-full md:w-auto bg-white/10 hover:bg-white/20 text-white rounded-xl py-3 px-6 text-sm font-bold transition-colors shadow-lg disabled:opacity-50 backdrop-blur-md border border-white/20"
                                            >
