                                        ...
                                        <div className="pt-4 border-t border-white/10">
                                            {!isPro ? (
                                                <>
                                                    ...
                                                    >
                                                        <img src="/kaspi-logo.png" alt="Kaspi" className="w-6 h-6 rounded-full" />
                                                        {language === 'kk' ? 'Pro жазылу' : language === 'ru' ? 'Перейти на Pro' : 'Pay via Kaspi'} — 980 ₸
                                                    </button>
                                                    <p className="text-xs text-white/50 text-center mt-2">
                                                        {language === 'kk' ? 'Kaspi Bank арқылы төлеу' : language === 'ru' ? 'Оплата через Kaspi Bank' : 'Contact author'}
                                                    </p>
                                                </>
                                            ) : (
